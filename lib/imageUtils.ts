...
/**
 * Represents the structure of a cover image object in metadata.
 */
...
/**
 * Resolves the final media path for use in components.
 *
 * Handles:
 * - External URLs (http/https)
 * - Absolute paths starting with '/'
 * - Relative paths within the content directory
 * - Fallback media
 * - Section-specific default media
 *
 * @param mediaSource - The primary media source (string URL or CoverMedia object).
 * @param fallbackMedia - A secondary media source (string URL) if the primary is not found.
 * @param section - The current content section (e.g., 'blog', 'projects').
 * @param fullSlug - The full slug of the content item.
 * @returns The resolved media path and type information.
 */
...
export function resolveImagePath(
  ...
  return resolveMediaPath(imageSource, fallbackImage, section, fullSlug).url;
}
