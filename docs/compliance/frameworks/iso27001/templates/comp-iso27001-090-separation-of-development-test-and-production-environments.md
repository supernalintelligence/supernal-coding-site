---
id: comp-iso27001-090-separation-of-development-test-and-production-environments
...
**Purpose**: Development, test and production environments shall be separated  
**ISO 27001 Control**: A.8.31  
...
Implements ISO 27001 control A.8.31 to development, test and production environments shall be separated. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Separation of Development, Test and Production Environments
  As an information security officer
  I want to implement separation of development, test and production environments
  So that I can meet ISO 27001 A.8.31 requirements
