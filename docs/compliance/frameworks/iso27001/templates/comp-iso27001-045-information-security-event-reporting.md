---
id: comp-iso27001-045-information-security-event-reporting
title: COMP-ISO27001-045 - Information Security Event Reporting
sidebar_label: COMP-ISO27001-045
sidebar_position: 45
---

# COMP-ISO27001-045: Information Security Event Reporting

## Overview

**Purpose**: Personnel shall report observed or suspected security events  
**ISO 27001 Control**: A.6.8  
**Category**: people  
**Priority**: high  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.6.8 to personnel shall report observed or suspected security events. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Security Event Reporting
  As an information security officer
  I want to implement information security event reporting
  So that I can meet ISO 27001 A.6.8 requirements
