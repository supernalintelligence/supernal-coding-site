---
id: comp-iso27001-052-clear-desk-and-clear-screen
...
**Purpose**: Clear desk and clear screen rules shall be defined  
...
Implements ISO 27001 control A.7.7 to clear desk and clear screen rules shall be defined. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Clear Desk and Clear Screen
  As an information security officer
  I want to implement clear desk and clear screen
  So that I can meet ISO 27001 A.7.7 requirements
