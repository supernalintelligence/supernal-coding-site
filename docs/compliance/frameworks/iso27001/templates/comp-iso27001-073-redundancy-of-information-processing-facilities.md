---
id: comp-iso27001-073-redundancy-of-information-processing-facilities
title: COMP-ISO27001-073 - Redundancy of Information Processing Facilities
sidebar_label: COMP-ISO27001-073
sidebar_position: 73
---

# COMP-ISO27001-073: Redundancy of Information Processing Facilities

## Overview

**Purpose**: Information processing facilities shall be implemented with redundancy  
**ISO 27001 Control**: A.8.14  
...
Implements ISO 27001 control A.8.14 to information processing facilities shall be implemented with redundancy. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Redundancy of Information Processing Facilities
  As an information security officer
  I want to implement redundancy of information processing facilities
  So that I can meet ISO 27001 A.8.14 requirements
