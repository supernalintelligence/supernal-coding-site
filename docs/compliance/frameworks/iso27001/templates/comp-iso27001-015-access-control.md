---
id: comp-iso27001-015-access-control
...
**Purpose**: Rules to control physical and logical access shall be established  
**ISO 27001 Control**: A.5.15  
...
Implements ISO 27001 control A.5.15 to rules to control physical and logical access shall be established. This control ensures compliance with international information security management standards.
...
Feature: Access Control
  ...
  So that I can meet ISO 27001 A.5.15 requirements
