---
id: comp-iso27001-005-contact-with-authorities
title: COMP-ISO27001-005 - Contact with Authorities
sidebar_label: COMP-ISO27001-005
sidebar_position: 5
---

# COMP-ISO27001-005: Contact with Authorities

## Overview

**Purpose**: Maintain contacts with relevant authorities  
**ISO 27001 Control**: A.5.5  
...
Implements ISO 27001 control A.5.5 to maintain contacts with relevant authorities. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Contact with Authorities
  As an information security officer
  I want to implement contact with authorities
  So that I can meet ISO 27001 A.5.5 requirements
