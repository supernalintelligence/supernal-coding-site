---
id: comp-iso27001-022-monitoring-review-and-change-management-of-supplier-services
...
**Purpose**: Monitor and review supplier services  
**ISO 27001 Control**: A.5.22  
...
Implements ISO 27001 control A.5.22 to monitor and review supplier services. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Monitoring, Review and Change Management of Supplier Services
  As an information security officer
  I want to implement monitoring, review and change management of supplier services
  So that I can meet ISO 27001 A.5.22 requirements
