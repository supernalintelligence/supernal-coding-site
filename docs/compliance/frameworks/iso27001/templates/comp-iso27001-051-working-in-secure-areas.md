---
id: comp-iso27001-051-working-in-secure-areas
title: COMP-ISO27001-051 - Working in Secure Areas
sidebar_label: COMP-ISO27001-051
sidebar_position: 51
---

# COMP-ISO27001-051: Working in Secure Areas

## Overview

**Purpose**: Security measures for working in secure areas shall be designed  
**ISO 27001 Control**: A.7.6  
**Category**: physical  
**Priority**: medium  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.7.6 to security measures for working in secure areas shall be designed. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Working in Secure Areas
  As an information security officer
  I want to implement working in secure areas
  So that I can meet ISO 27001 A.7.6 requirements
