---
id: comp-iso27001-036-compliance-with-policies-rules-and-standards
...
**Purpose**: Compliance shall be regularly reviewed  
**ISO 27001 Control**: A.5.36  
...
Implements ISO 27001 control A.5.36 to compliance shall be regularly reviewed. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Compliance with Policies, Rules and Standards
  As an information security officer
  I want to implement compliance with policies, rules and standards
  So that I can meet ISO 27001 A.5.36 requirements
