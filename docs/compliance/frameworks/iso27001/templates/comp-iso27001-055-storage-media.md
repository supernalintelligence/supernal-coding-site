---
id: comp-iso27001-055-storage-media
...
**Purpose**: Storage media shall be managed through their lifecycle  
**ISO 27001 Control**: A.7.10  
**Category**: physical  
**Priority**: medium  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.7.10 to storage media shall be managed through their lifecycle. This control ensures compliance with international information security management standards.
...
Feature: Storage Media
  ...
  I want to implement storage media
  So that I can meet ISO 27001 A.7.10 requirements
