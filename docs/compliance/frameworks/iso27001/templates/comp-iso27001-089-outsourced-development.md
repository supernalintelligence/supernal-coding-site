---
id: comp-iso27001-089-outsourced-development
...
**Purpose**: Organization shall direct, monitor and review outsourced development  
**ISO 27001 Control**: A.8.30  
...
Implements ISO 27001 control A.8.30 to organization shall direct, monitor and review outsourced development. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Outsourced Development
  As an information security officer
  I want to implement outsourced development
  So that I can meet ISO 27001 A.8.30 requirements
