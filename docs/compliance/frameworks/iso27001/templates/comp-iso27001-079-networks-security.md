---
id: comp-iso27001-079-networks-security
title: COMP-ISO27001-079 - Networks Security
sidebar_label: COMP-ISO27001-079
sidebar_position: 79
---

# COMP-ISO27001-079: Networks Security

## Overview

**Purpose**: Networks and network devices shall be secured, managed and controlled  
...
Implements ISO 27001 control A.8.20 to networks and network devices shall be secured, managed and controlled. This control ensures compliance with international information security management standards.
...
Feature: Networks Security
  ...
  I want to implement networks security
  So that I can meet ISO 27001 A.8.20 requirements
