---
id: comp-iso27001-072-information-backup
...
**Purpose**: Backup copies of information and software shall be maintained and tested  
**ISO 27001 Control**: A.8.13  
...
Implements ISO 27001 control A.8.13 to backup copies of information and software shall be maintained and tested. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Backup
  As an information security officer
  I want to implement information backup
  So that I can meet ISO 27001 A.8.13 requirements
