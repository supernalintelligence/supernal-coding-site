---
id: comp-iso27001-021-managing-information-security-in-ict-supply-chain
...
**Purpose**: Manage information security risks in ICT supply chain  
**ISO 27001 Control**: A.5.21  
...
Implements ISO 27001 control A.5.21 to manage information security risks in ict supply chain. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Managing Information Security in ICT Supply Chain
  As an information security officer
  I want to implement managing information security in ict supply chain
  So that I can meet ISO 27001 A.5.21 requirements
