---
id: comp-iso27001-081-segregation-of-networks
...
**Purpose**: Groups of information services, users and systems shall be segregated  
**ISO 27001 Control**: A.8.22  
...
Implements ISO 27001 control A.8.22 to groups of information services, users and systems shall be segregated. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Segregation of Networks
  As an information security officer
  I want to implement segregation of networks
  So that I can meet ISO 27001 A.8.22 requirements
