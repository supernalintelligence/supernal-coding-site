---
id: comp-iso27001-080-security-of-network-services
...
**Purpose**: Security mechanisms and service levels for network services shall be identified  
**ISO 27001 Control**: A.8.21  
...
Implements ISO 27001 control A.8.21 to security mechanisms and service levels for network services shall be identified. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Security of Network Services
  As an information security officer
  I want to implement security of network services
  So that I can meet ISO 27001 A.8.21 requirements
