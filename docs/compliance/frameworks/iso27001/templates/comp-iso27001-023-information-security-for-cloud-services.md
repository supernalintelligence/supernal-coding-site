---
id: comp-iso27001-023-information-security-for-cloud-services
...
**Purpose**: Procedures for acquisition, use, management of cloud services  
...
Implements ISO 27001 control A.5.23 to procedures for acquisition, use, management of cloud services. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Security for Cloud Services
  As an information security officer
  I want to implement information security for cloud services
  So that I can meet ISO 27001 A.5.23 requirements
