---
id: comp-iso27001-077-use-of-privileged-utility-programs
title: COMP-ISO27001-077 - Use of Privileged Utility Programs
sidebar_label: COMP-ISO27001-077
sidebar_position: 77
---

# COMP-ISO27001-077: Use of Privileged Utility Programs

## Overview

**Purpose**: Use of utility programs that can override system controls shall be restricted  
**ISO 27001 Control**: A.8.18  
...
Implements ISO 27001 control A.8.18 to use of utility programs that can override system controls shall be restricted. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Use of Privileged Utility Programs
  As an information security officer
  I want to implement use of privileged utility programs
  So that I can meet ISO 27001 A.8.18 requirements
