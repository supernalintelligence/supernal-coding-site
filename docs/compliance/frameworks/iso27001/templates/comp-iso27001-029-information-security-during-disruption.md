---
id: comp-iso27001-029-information-security-during-disruption
...
**Purpose**: Plan to maintain security operations during disruptions  
**ISO 27001 Control**: A.5.29  
...
Implements ISO 27001 control A.5.29 to plan to maintain security operations during disruptions. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Security During Disruption
  As an information security officer
  I want to implement information security during disruption
  So that I can meet ISO 27001 A.5.29 requirements
