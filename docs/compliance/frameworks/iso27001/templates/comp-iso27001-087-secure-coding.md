---
id: comp-iso27001-087-secure-coding
...
Implements ISO 27001 control A.8.28 to secure coding principles shall be applied to software development. This control ensures compliance with international information security management standards.
...
Feature: Secure Coding
  ...
  I want to implement secure coding
  So that I can meet ISO 27001 A.8.28 requirements
