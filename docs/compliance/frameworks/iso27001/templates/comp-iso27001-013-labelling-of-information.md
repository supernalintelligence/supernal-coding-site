---
id: comp-iso27001-013-labelling-of-information
...
**Purpose**: Develop and implement procedures for information labelling  
**ISO 27001 Control**: A.5.13  
...
Implements ISO 27001 control A.5.13 to develop and implement procedures for information labelling. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Labelling of Information
  As an information security officer
  I want to implement labelling of information
  So that I can meet ISO 27001 A.5.13 requirements
