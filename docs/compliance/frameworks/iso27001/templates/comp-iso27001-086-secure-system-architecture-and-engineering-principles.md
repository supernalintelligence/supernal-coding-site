---
id: comp-iso27001-086-secure-system-architecture-and-engineering-principles
title: COMP-ISO27001-086 - Secure System Architecture and Engineering Principles
sidebar_label: COMP-ISO27001-086
sidebar_position: 86
---

# COMP-ISO27001-086: Secure System Architecture and Engineering Principles

## Overview

**Purpose**: Principles for engineering secure systems shall be established  
**ISO 27001 Control**: A.8.27  
...
Implements ISO 27001 control A.8.27 to principles for engineering secure systems shall be established. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Secure System Architecture and Engineering Principles
  As an information security officer
  I want to implement secure system architecture and engineering principles
  So that I can meet ISO 27001 A.8.27 requirements
