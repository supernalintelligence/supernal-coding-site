---
id: comp-iso27001-075-monitoring-activities
...
**Purpose**: Networks, systems and applications shall be monitored for anomalous behavior  
...
Implements ISO 27001 control A.8.16 to networks, systems and applications shall be monitored for anomalous behavior. This control ensures compliance with international information security management standards.
...
Feature: Monitoring Activities
  ...
  I want to implement monitoring activities
  So that I can meet ISO 27001 A.8.16 requirements
