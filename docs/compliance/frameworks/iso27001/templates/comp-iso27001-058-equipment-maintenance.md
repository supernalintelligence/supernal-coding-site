---
id: comp-iso27001-058-equipment-maintenance
...
**Purpose**: Equipment shall be correctly maintained to ensure availability and integrity  
...
Implements ISO 27001 control A.7.13 to equipment shall be correctly maintained to ensure availability and integrity. This control ensures compliance with international information security management standards.
...
Feature: Equipment Maintenance
  ...
  I want to implement equipment maintenance
  So that I can meet ISO 27001 A.7.13 requirements
