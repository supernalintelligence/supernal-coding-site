---
id: comp-iso27001-084-secure-development-life-cycle
...
**Purpose**: Rules for secure development of software and systems shall be established  
**ISO 27001 Control**: A.8.25  
...
Implements ISO 27001 control A.8.25 to rules for secure development of software and systems shall be established. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Secure Development Life Cycle
  As an information security officer
  I want to implement secure development life cycle
  So that I can meet ISO 27001 A.8.25 requirements
