---
id: comp-iso27001-093-protection-of-information-systems-during-audit-testing
...
**Purpose**: Audit tests shall be planned and agreed to minimize disruption  
**ISO 27001 Control**: A.8.34  
...
Implements ISO 27001 control A.8.34 to audit tests shall be planned and agreed to minimize disruption. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Protection of Information Systems During Audit Testing
  As an information security officer
  I want to implement protection of information systems during audit testing
  So that I can meet ISO 27001 A.8.34 requirements
