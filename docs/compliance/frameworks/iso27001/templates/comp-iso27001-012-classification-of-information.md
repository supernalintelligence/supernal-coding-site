---
id: comp-iso27001-012-classification-of-information
...
**Purpose**: Information shall be classified according to legal, value, criticality and sensitivity  
**ISO 27001 Control**: A.5.12  
...
Implements ISO 27001 control A.5.12 to information shall be classified according to legal, value, criticality and sensitivity. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Classification of Information
  As an information security officer
  I want to implement classification of information
  So that I can meet ISO 27001 A.5.12 requirements
