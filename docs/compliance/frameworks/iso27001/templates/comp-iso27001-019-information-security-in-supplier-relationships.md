---
id: comp-iso27001-019-information-security-in-supplier-relationships
...
**Purpose**: Processes to ensure security in supplier relationships  
...
Implements ISO 27001 control A.5.19 to processes to ensure security in supplier relationships. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Security in Supplier Relationships
  As an information security officer
  I want to implement information security in supplier relationships
  So that I can meet ISO 27001 A.5.19 requirements
