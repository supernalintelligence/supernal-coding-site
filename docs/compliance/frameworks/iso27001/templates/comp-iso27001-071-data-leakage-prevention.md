---
id: comp-iso27001-071-data-leakage-prevention
...
**Purpose**: Data leakage prevention measures shall be applied to systems and networks  
**ISO 27001 Control**: A.8.12  
...
Implements ISO 27001 control A.8.12 to data leakage prevention measures shall be applied to systems and networks. This control ensures compliance with international information security management standards.
...
Feature: Data Leakage Prevention
  ...
  I want to implement data leakage prevention
  So that I can meet ISO 27001 A.8.12 requirements
