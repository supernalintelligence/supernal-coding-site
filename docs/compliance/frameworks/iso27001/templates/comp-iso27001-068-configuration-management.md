---
id: comp-iso27001-068-configuration-management
...
**Purpose**: Configurations of hardware, software, services and networks shall be managed  
**ISO 27001 Control**: A.8.9  
...
Implements ISO 27001 control A.8.9 to configurations of hardware, software, services and networks shall be managed. This control ensures compliance with international information security management standards.
...
Feature: Configuration Management
  ...
  I want to implement configuration management
  So that I can meet ISO 27001 A.8.9 requirements
