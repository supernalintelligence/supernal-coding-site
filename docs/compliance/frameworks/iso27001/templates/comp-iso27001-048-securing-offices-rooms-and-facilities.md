---
id: comp-iso27001-048-securing-offices-rooms-and-facilities
...
**Purpose**: Physical security for offices, rooms and facilities shall be designed  
**ISO 27001 Control**: A.7.3  
**Category**: physical  
**Priority**: medium  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.7.3 to physical security for offices, rooms and facilities shall be designed. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Securing Offices, Rooms and Facilities
  As an information security officer
  I want to implement securing offices, rooms and facilities
  So that I can meet ISO 27001 A.7.3 requirements
