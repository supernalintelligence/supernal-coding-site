---
id: comp-iso27001-002-information-security-roles-and-responsibilities
...
**Purpose**: Define and allocate information security roles and responsibilities  
**ISO 27001 Control**: A.5.2  
...
Implements ISO 27001 control A.5.2 to define and allocate information security roles and responsibilities. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Security Roles and Responsibilities
  As an information security officer
  I want to implement information security roles and responsibilities
  So that I can meet ISO 27001 A.5.2 requirements
