---
id: comp-iso27001-083-use-of-cryptography
...
**Purpose**: Rules for effective use of cryptography shall be defined and implemented  
...
Implements ISO 27001 control A.8.24 to rules for effective use of cryptography shall be defined and implemented. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Use of Cryptography
  As an information security officer
  I want to implement use of cryptography
  So that I can meet ISO 27001 A.8.24 requirements
