---
id: comp-iso27001-006-contact-with-special-interest-groups
...
**Purpose**: Maintain contacts with security forums and professional associations  
**ISO 27001 Control**: A.5.6  
...
Implements ISO 27001 control A.5.6 to maintain contacts with security forums and professional associations. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Contact with Special Interest Groups
  As an information security officer
  I want to implement contact with special interest groups
  So that I can meet ISO 27001 A.5.6 requirements
