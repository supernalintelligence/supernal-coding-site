---
id: comp-iso27001-011-return-of-assets
...
**Purpose**: Personnel shall return all organizational assets upon termination  
**ISO 27001 Control**: A.5.11  
...
Implements ISO 27001 control A.5.11 to personnel shall return all organizational assets upon termination. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Return of Assets
  As an information security officer
  I want to implement return of assets
  So that I can meet ISO 27001 A.5.11 requirements
