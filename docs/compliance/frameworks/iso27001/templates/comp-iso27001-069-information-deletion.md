---
id: comp-iso27001-069-information-deletion
...
**Purpose**: Information in systems, devices or storage shall be deleted when no longer required  
...
Implements ISO 27001 control A.8.10 to information in systems, devices or storage shall be deleted when no longer required. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Deletion
  As an information security officer
  I want to implement information deletion
  So that I can meet ISO 27001 A.8.10 requirements
