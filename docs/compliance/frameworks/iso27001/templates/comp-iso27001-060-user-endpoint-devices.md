---
id: comp-iso27001-060-user-endpoint-devices
...
**Purpose**: Information on user endpoint devices shall be protected  
**ISO 27001 Control**: A.8.1  
...
Implements ISO 27001 control A.8.1 to information on user endpoint devices shall be protected. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: User Endpoint Devices
  As an information security officer
  I want to implement user endpoint devices
  So that I can meet ISO 27001 A.8.1 requirements
