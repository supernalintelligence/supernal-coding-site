---
id: comp-iso27001-038-screening
...
**Purpose**: Background verification checks on candidates prior to joining  
**ISO 27001 Control**: A.6.1  
**Category**: people  
**Priority**: high  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.6.1 to background verification checks on candidates prior to joining. This control ensures compliance with international information security management standards.
...
Feature: Screening
  ...
  I want to implement screening
  So that I can meet ISO 27001 A.6.1 requirements
