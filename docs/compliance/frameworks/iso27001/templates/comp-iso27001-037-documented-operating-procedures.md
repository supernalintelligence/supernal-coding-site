---
id: comp-iso27001-037-documented-operating-procedures
...
**Purpose**: Operating procedures shall be documented and made available  
**ISO 27001 Control**: A.5.37  
...
Implements ISO 27001 control A.5.37 to operating procedures shall be documented and made available. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Documented Operating Procedures
  As an information security officer
  I want to implement documented operating procedures
  So that I can meet ISO 27001 A.5.37 requirements
