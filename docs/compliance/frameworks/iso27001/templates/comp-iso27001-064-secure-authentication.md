---
id: comp-iso27001-064-secure-authentication
...
**Purpose**: Secure authentication technologies and procedures shall be implemented  
**ISO 27001 Control**: A.8.5  
...
Implements ISO 27001 control A.8.5 to secure authentication technologies and procedures shall be implemented. This control ensures compliance with international information security management standards.
...
Feature: Secure Authentication
  ...
  I want to implement secure authentication
  So that I can meet ISO 27001 A.8.5 requirements
