---
id: comp-iso27001-061-privileged-access-rights
...
**Purpose**: Allocation and use of privileged access rights shall be restricted  
...
Implements ISO 27001 control A.8.2 to allocation and use of privileged access rights shall be restricted. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Privileged Access Rights
  As an information security officer
  I want to implement privileged access rights
  So that I can meet ISO 27001 A.8.2 requirements
