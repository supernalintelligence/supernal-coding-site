---
id: comp-iso27001-042-responsibilities-after-termination
...
**Purpose**: Information security responsibilities after termination shall be defined  
...
Implements ISO 27001 control A.6.5 to information security responsibilities after termination shall be defined. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Responsibilities After Termination
  As an information security officer
  I want to implement responsibilities after termination
  So that I can meet ISO 27001 A.6.5 requirements
