---
id: comp-iso27001-076-clock-synchronization
title: COMP-ISO27001-076 - Clock Synchronization
sidebar_label: COMP-ISO27001-076
sidebar_position: 76
---

# COMP-ISO27001-076: Clock Synchronization

## Overview

**Purpose**: Clocks of systems shall be synchronized to approved time sources  
**ISO 27001 Control**: A.8.17  
...
Implements ISO 27001 control A.8.17 to clocks of systems shall be synchronized to approved time sources. This control ensures compliance with international information security management standards.
...
Feature: Clock Synchronization
  ...
  I want to implement clock synchronization
  So that I can meet ISO 27001 A.8.17 requirements
