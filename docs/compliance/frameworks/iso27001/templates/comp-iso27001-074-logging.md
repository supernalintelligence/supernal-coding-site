---
id: comp-iso27001-074-logging
title: COMP-ISO27001-074 - Logging
sidebar_label: COMP-ISO27001-074
sidebar_position: 74
---

# COMP-ISO27001-074: Logging

## Overview

**Purpose**: Logs that record activities, exceptions, faults and events shall be produced  
**ISO 27001 Control**: A.8.15  
...
Implements ISO 27001 control A.8.15 to logs that record activities, exceptions, faults and events shall be produced. This control ensures compliance with international information security management standards.
...
Feature: Logging
  ...
  I want to implement logging
  So that I can meet ISO 27001 A.8.15 requirements
