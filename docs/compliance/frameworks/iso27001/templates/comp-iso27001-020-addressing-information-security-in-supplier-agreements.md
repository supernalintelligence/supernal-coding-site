---
id: comp-iso27001-020-addressing-information-security-in-supplier-agreements
...
**Purpose**: Security requirements in supplier agreements  
...
Implements ISO 27001 control A.5.20 to security requirements in supplier agreements. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Addressing Information Security in Supplier Agreements
  As an information security officer
  I want to implement addressing information security in supplier agreements
  So that I can meet ISO 27001 A.5.20 requirements
