---
id: comp-iso27001-043-confidentiality-or-non-disclosure-agreements
...
**Purpose**: Requirements for confidentiality or NDAs shall be identified and reviewed  
**ISO 27001 Control**: A.6.6  
**Category**: people  
**Priority**: high  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.6.6 to requirements for confidentiality or ndas shall be identified and reviewed. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Confidentiality or Non-Disclosure Agreements
  As an information security officer
  I want to implement confidentiality or non-disclosure agreements
  So that I can meet ISO 27001 A.6.6 requirements
