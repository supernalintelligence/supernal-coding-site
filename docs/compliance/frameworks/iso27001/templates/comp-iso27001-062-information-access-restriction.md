---
id: comp-iso27001-062-information-access-restriction
title: COMP-ISO27001-062 - Information Access Restriction
sidebar_label: COMP-ISO27001-062
sidebar_position: 62
---

# COMP-ISO27001-062: Information Access Restriction

## Overview

**Purpose**: Access to information and systems shall be restricted per access control policy  
...
Implements ISO 27001 control A.8.3 to access to information and systems shall be restricted per access control policy. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Access Restriction
  As an information security officer
  I want to implement information access restriction
  So that I can meet ISO 27001 A.8.3 requirements
