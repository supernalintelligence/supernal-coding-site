---
id: comp-iso27001-091-change-management
...
**Purpose**: Changes to information processing facilities shall be subject to change management  
...
Implements ISO 27001 control A.8.32 to changes to information processing facilities shall be subject to change management. This control ensures compliance with international information security management standards.
...
Feature: Change Management
  ...
  So that I can meet ISO 27001 A.8.32 requirements
