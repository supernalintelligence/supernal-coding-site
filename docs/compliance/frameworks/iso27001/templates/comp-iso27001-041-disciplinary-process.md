---
id: comp-iso27001-041-disciplinary-process
...
**Purpose**: Formal disciplinary process for personnel who commit security breaches  
**ISO 27001 Control**: A.6.4  
**Category**: people  
**Priority**: medium  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.6.4 to formal disciplinary process for personnel who commit security breaches. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Disciplinary Process
  As an information security officer
  I want to implement disciplinary process
  So that I can meet ISO 27001 A.6.4 requirements
