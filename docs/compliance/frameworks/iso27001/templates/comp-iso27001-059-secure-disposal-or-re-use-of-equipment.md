---
id: comp-iso27001-059-secure-disposal-or-re-use-of-equipment
title: COMP-ISO27001-059 - Secure Disposal or Re-use of Equipment
sidebar_label: COMP-ISO27001-059
sidebar_position: 59
---

# COMP-ISO27001-059: Secure Disposal or Re-use of Equipment

## Overview

**Purpose**: Items of equipment shall be verified, erased or destroyed prior to disposal  
**ISO 27001 Control**: A.7.14  
**Category**: physical  
**Priority**: high  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.7.14 to items of equipment shall be verified, erased or destroyed prior to disposal. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Secure Disposal or Re-use of Equipment
  As an information security officer
  I want to implement secure disposal or re-use of equipment
  So that I can meet ISO 27001 A.7.14 requirements
