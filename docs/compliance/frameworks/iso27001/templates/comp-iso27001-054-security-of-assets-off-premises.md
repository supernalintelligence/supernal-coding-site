---
id: comp-iso27001-054-security-of-assets-off-premises
...
**Purpose**: Off-premises assets shall be protected  
**ISO 27001 Control**: A.7.9  
**Category**: physical  
**Priority**: high  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.7.9 to off-premises assets shall be protected. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Security of Assets Off-Premises
  As an information security officer
  I want to implement security of assets off-premises
  So that I can meet ISO 27001 A.7.9 requirements
