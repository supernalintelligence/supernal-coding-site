---
id: comp-iso27001-010-acceptable-use-of-information-and-assets
...
**Purpose**: Rules for acceptable use of information and assets shall be identified  
...
Implements ISO 27001 control A.5.10 to rules for acceptable use of information and assets shall be identified. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Acceptable Use of Information and Assets
  As an information security officer
  I want to implement acceptable use of information and assets
  So that I can meet ISO 27001 A.5.10 requirements
