---
id: comp-iso27001-008-information-security-in-project-management
...
Implements ISO 27001 control A.5.8 to integrate information security into project management. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Information Security in Project Management
  As an information security officer
  I want to implement information security in project management
  So that I can meet ISO 27001 A.5.8 requirements
