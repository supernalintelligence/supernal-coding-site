---
id: comp-iso27001-047-physical-entry
title: COMP-ISO27001-047 - Physical Entry
sidebar_label: COMP-ISO27001-047
sidebar_position: 47
---

# COMP-ISO27001-047: Physical Entry

## Overview

**Purpose**: Secure areas shall be protected by appropriate entry controls  
**ISO 27001 Control**: A.7.2  
**Category**: physical  
**Priority**: high  
**Framework**: ISO 27001
...
Implements ISO 27001 control A.7.2 to secure areas shall be protected by appropriate entry controls. This control ensures compliance with international information security management standards.

## Acceptance Criteria

```gherkin
Feature: Physical Entry
  As an information security officer
  I want to implement physical entry
  So that I can meet ISO 27001 A.7.2 requirements
