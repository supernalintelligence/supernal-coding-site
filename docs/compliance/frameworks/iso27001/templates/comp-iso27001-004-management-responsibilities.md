---
id: comp-iso27001-004-management-responsibilities
...
**Purpose**: Management shall require personnel to apply information security  
**ISO 27001 Control**: A.5.4  
...
Implements ISO 27001 control A.5.4 to management shall require personnel to apply information security. This control ensures compliance with international information security management standards.
...
Feature: Management Responsibilities
  ...
  I want to implement management responsibilities
  So that I can meet ISO 27001 A.5.4 requirements
