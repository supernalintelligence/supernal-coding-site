---
id: comp-iso27001-082-web-filtering
...
**Purpose**: Access to external websites shall be managed to reduce exposure  
**ISO 27001 Control**: A.8.23  
...
Implements ISO 27001 control A.8.23 to access to external websites shall be managed to reduce exposure. This control ensures compliance with international information security management standards.
...
Feature: Web Filtering
  ...
  I want to implement web filtering
  So that I can meet ISO 27001 A.8.23 requirements
