---
id: comp-iso27001-016-identity-management
...
**Purpose**: Full lifecycle of identities shall be managed  
**ISO 27001 Control**: A.5.16  
...
Implements ISO 27001 control A.5.16 to full lifecycle of identities shall be managed. This control ensures compliance with international information security management standards.
...
Feature: Identity Management
  ...
  I want to implement identity management
  So that I can meet ISO 27001 A.5.16 requirements
