---
id: comp-iso27001-017-authentication-information
...
**Purpose**: Allocation and management of authentication information shall be controlled  
**ISO 27001 Control**: A.5.17  
...
Implements ISO 27001 control A.5.17 to allocation and management of authentication information shall be controlled. This control ensures compliance with international information security management standards.
...
Feature: Authentication Information
  ...
  I want to implement authentication information
  So that I can meet ISO 27001 A.5.17 requirements
