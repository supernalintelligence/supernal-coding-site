...
**Purpose**: Obtain and manage consent when used as lawful basis  
**ISO 27701 Control**: 6.7.1.3  
...
Implements ISO 27701 control 6.7.1.3 to obtain and manage consent when used as lawful basis. This privacy-specific control extends ISO 27001 requirements to address privacy information management.
...
Feature: Consent
  ...
  I want to implement consent
  So that I can meet ISO 27701 6.7.1.3 requirements
