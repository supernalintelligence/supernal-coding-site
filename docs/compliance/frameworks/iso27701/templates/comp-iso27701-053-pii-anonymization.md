---
id: comp-iso27701-053-pii-anonymization
...
**Purpose**: Implement anonymization techniques  
**ISO 27701 Control**: 6.15.2  
...
Implements ISO 27701 control 6.15.2 to implement anonymization techniques. This privacy-specific control extends ISO 27001 requirements to address privacy information management.
...
Feature: PII Anonymization
  ...
  I want to implement pii anonymization
  So that I can meet ISO 27701 6.15.2 requirements
