---
id: comp-iso27701-042-transparency-of-processing
...
**Purpose**: Ensure transparency in all PII processing  
**ISO 27701 Control**: 6.11.2  
...
Implements ISO 27701 control 6.11.2 to ensure transparency in all pii processing. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Transparency of Processing
  As a privacy officer
  I want to implement transparency of processing
  So that I can meet ISO 27701 6.11.2 requirements
