---
id: comp-iso27701-060-privacy-testing
...
**Purpose**: Regular testing of privacy measures  
**ISO 27701 Control**: 6.17.2  
...
Implements ISO 27701 control 6.17.2 to regular testing of privacy measures. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Privacy Testing
  As a privacy officer
  I want to implement privacy testing
  So that I can meet ISO 27701 6.17.2 requirements
