---
id: comp-iso27701-045-sharing-pii-with-third-parties
...
**Purpose**: Control PII sharing with third parties  
**ISO 27701 Control**: 6.12.1  
...
Implements ISO 27701 control 6.12.1 to control pii sharing with third parties. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Sharing PII with Third Parties
  As a privacy officer
  I want to implement sharing pii with third parties
  So that I can meet ISO 27701 6.12.1 requirements
