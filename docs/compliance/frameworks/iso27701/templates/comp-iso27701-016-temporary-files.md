---
id: comp-iso27701-016-temporary-files
...
**Purpose**: Manage temporary files containing PII  
**ISO 27701 Control**: 6.7.3.1  
...
Implements ISO 27701 control 6.7.3.1 to manage temporary files containing pii. This privacy-specific control extends ISO 27001 requirements to address privacy information management.
...
Feature: Temporary Files
  ...
  I want to implement temporary files
  So that I can meet ISO 27701 6.7.3.1 requirements
