---
id: comp-iso27701-012-obligations-to-data-subjects-erasure
...
**Purpose**: Enable data subjects to request erasure  
**ISO 27701 Control**: 6.7.2.5  
...
Implements ISO 27701 control 6.7.2.5 to enable data subjects to request erasure. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Obligations to Data Subjects - Erasure
  As a privacy officer
  I want to implement obligations to data subjects - erasure
  So that I can meet ISO 27701 6.7.2.5 requirements
