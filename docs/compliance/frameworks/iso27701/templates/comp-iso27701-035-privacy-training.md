---
id: comp-iso27701-035-privacy-training
...
**Purpose**: Provide privacy-specific training  
**ISO 27701 Control**: 6.9.5  
...
Implements ISO 27701 control 6.9.5 to provide privacy-specific training. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Privacy Training
  As a privacy officer
  I want to implement privacy training
  So that I can meet ISO 27701 6.9.5 requirements
