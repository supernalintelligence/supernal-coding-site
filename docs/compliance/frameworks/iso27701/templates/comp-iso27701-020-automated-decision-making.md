---
id: comp-iso27701-020-automated-decision-making
...
**Purpose**: Implement controls for automated decision-making systems  
**ISO 27701 Control**: 6.7.3.5  
...
Implements ISO 27701 control 6.7.3.5 to implement controls for automated decision-making systems. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Automated Decision Making
  As a privacy officer
  I want to implement automated decision making
  So that I can meet ISO 27701 6.7.3.5 requirements
