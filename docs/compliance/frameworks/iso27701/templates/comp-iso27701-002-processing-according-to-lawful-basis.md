---
id: comp-iso27701-002-processing-according-to-lawful-basis
...
**Purpose**: Ensure processing is consistent with lawful basis  
**ISO 27701 Control**: 6.7.1.2  
...
Implements ISO 27701 control 6.7.1.2 to ensure processing is consistent with lawful basis. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Processing According to Lawful Basis
  As a privacy officer
  I want to implement processing according to lawful basis
  So that I can meet ISO 27701 6.7.1.2 requirements
