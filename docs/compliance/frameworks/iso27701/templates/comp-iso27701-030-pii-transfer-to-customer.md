---
id: comp-iso27701-030-pii-transfer-to-customer
...
**Purpose**: Facilitate PII transfer to customer when requested  
**ISO 27701 Control**: 6.8.3.2  
...
Implements ISO 27701 control 6.8.3.2 to facilitate pii transfer to customer when requested. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: PII Transfer to Customer
  As a privacy officer
  I want to implement pii transfer to customer
  So that I can meet ISO 27701 6.8.3.2 requirements
