---
id: comp-iso27701-036-processing-pii-of-children
...
**Purpose**: Implement additional protections for children's data  
**ISO 27701 Control**: 6.9.6  
**Category**: privacy-special  
**Priority**: high  
**Framework**: ISO 27701 (Privacy Extension)

## Description

Implements ISO 27701 control 6.9.6 to implement additional protections for children's data. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Processing PII of Children
  As a privacy officer
  I want to implement processing pii of children
  So that I can meet ISO 27701 6.9.6 requirements
