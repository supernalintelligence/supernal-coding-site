---
id: comp-iso27701-022-limitation-of-processing
...
**Purpose**: Process PII only per customer instructions  
**ISO 27701 Control**: 6.8.1.2  
...
Implements ISO 27701 control 6.8.1.2 to process pii only per customer instructions. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Limitation of Processing
  As a privacy officer
  I want to implement limitation of processing
  So that I can meet ISO 27701 6.8.1.2 requirements
