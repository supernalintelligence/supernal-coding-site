---
id: comp-iso27701-015-obligations-to-data-subjects-portability
...
**Purpose**: Provide data portability where required  
**ISO 27701 Control**: 6.7.2.8  
...
Implements ISO 27701 control 6.7.2.8 to provide data portability where required. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Obligations to Data Subjects - Portability
  As a privacy officer
  I want to implement obligations to data subjects - portability
  So that I can meet ISO 27701 6.7.2.8 requirements
