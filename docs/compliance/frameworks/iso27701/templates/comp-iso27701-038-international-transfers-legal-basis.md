---
id: comp-iso27701-038-international-transfers-legal-basis
title: COMP-ISO27701-038 - International Transfers - Legal Basis
sidebar_label: COMP-ISO27701-038
sidebar_position: 38
---

# COMP-ISO27701-038: International Transfers - Legal Basis

## Overview

**Purpose**: Establish legal basis for international transfers  
**ISO 27701 Control**: 6.10.1  
**Category**: privacy-transfer  
**Priority**: high  
**Framework**: ISO 27701 (Privacy Extension)

## Description

Implements ISO 27701 control 6.10.1 to establish legal basis for international transfers. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: International Transfers - Legal Basis
  As a privacy officer
  I want to implement international transfers - legal basis
  So that I can meet ISO 27701 6.10.1 requirements
