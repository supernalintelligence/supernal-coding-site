---
id: comp-iso27701-001-identify-lawful-basis
...
**Purpose**: Identify and document lawful basis for PII processing  
**ISO 27701 Control**: 6.7.1.1  
...
Implements ISO 27701 control 6.7.1.1 to identify and document lawful basis for pii processing. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Identify Lawful Basis
  As a privacy officer
  I want to implement identify lawful basis
  So that I can meet ISO 27701 6.7.1.1 requirements
