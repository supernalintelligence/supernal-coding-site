---
id: comp-iso27701-039-international-transfers-safeguards
...
**Purpose**: Implement appropriate safeguards for transfers  
**ISO 27701 Control**: 6.10.2  
...
Implements ISO 27701 control 6.10.2 to implement appropriate safeguards for transfers. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: International Transfers - Safeguards
  As a privacy officer
  I want to implement international transfers - safeguards
  So that I can meet ISO 27701 6.10.2 requirements
