---
id: comp-iso27701-024-notification-of-breach
...
**Purpose**: Notify customers of PII breaches  
**ISO 27701 Control**: 6.8.1.4  
...
Implements ISO 27701 control 6.8.1.4 to notify customers of pii breaches. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Notification of Breach
  As a privacy officer
  I want to implement notification of breach
  So that I can meet ISO 27701 6.8.1.4 requirements
