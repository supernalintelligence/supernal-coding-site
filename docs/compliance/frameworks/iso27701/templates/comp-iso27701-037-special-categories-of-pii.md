---
id: comp-iso27701-037-special-categories-of-pii
...
**Purpose**: Enhanced protection for sensitive PII  
**ISO 27701 Control**: 6.9.7  
...
Implements ISO 27701 control 6.9.7 to enhanced protection for sensitive pii. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Special Categories of PII
  As a privacy officer
  I want to implement special categories of pii
  So that I can meet ISO 27701 6.9.7 requirements
