---
id: comp-iso27701-047-marketing-and-analytics
...
**Purpose**: Manage PII for marketing and analytics  
**ISO 27701 Control**: 6.12.3  
...
Implements ISO 27701 control 6.12.3 to manage pii for marketing and analytics. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Marketing and Analytics
  As a privacy officer
  I want to implement marketing and analytics
  So that I can meet ISO 27701 6.12.3 requirements
