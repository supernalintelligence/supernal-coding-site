---
id: comp-iso27701-029-return-or-destruction-of-pii
...
**Purpose**: Return or destroy PII upon contract termination  
**ISO 27701 Control**: 6.8.3.1  
**Category**: privacy-processor  
**Priority**: high  
**Framework**: ISO 27701 (Privacy Extension)

## Description

Implements ISO 27701 control 6.8.3.1 to return or destroy pii upon contract termination. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Return or Destruction of PII
  As a privacy officer
  I want to implement return or destruction of pii
  So that I can meet ISO 27701 6.8.3.1 requirements
