---
id: comp-iso27701-004-providing-privacy-notice
...
**Purpose**: Provide clear privacy notice to data subjects  
**ISO 27701 Control**: 6.7.1.4  
...
Implements ISO 27701 control 6.7.1.4 to provide clear privacy notice to data subjects. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Providing Privacy Notice
  As a privacy officer
  I want to implement providing privacy notice
  So that I can meet ISO 27701 6.7.1.4 requirements
