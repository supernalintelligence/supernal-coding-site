---
id: comp-iso27701-025-assistance-to-customer
...
**Purpose**: Assist customers with data subject requests  
**ISO 27701 Control**: 6.8.1.5  
...
Implements ISO 27701 control 6.8.1.5 to assist customers with data subject requests. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Assistance to Customer
  As a privacy officer
  I want to implement assistance to customer
  So that I can meet ISO 27701 6.8.1.5 requirements
