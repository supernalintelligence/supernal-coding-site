---
id: comp-iso27701-032-privacy-by-default
...
**Purpose**: Implement privacy-protective default settings  
**ISO 27701 Control**: 6.9.2  
...
Implements ISO 27701 control 6.9.2 to implement privacy-protective default settings. This privacy-specific control extends ISO 27001 requirements to address privacy information management.
...
Feature: Privacy by Default
  ...
  I want to implement privacy by default
  So that I can meet ISO 27701 6.9.2 requirements
