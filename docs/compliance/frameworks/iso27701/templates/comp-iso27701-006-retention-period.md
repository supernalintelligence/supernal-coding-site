---
id: comp-iso27701-006-retention-period
...
**Purpose**: Define and enforce PII retention periods  
**ISO 27701 Control**: 6.7.1.6  
...
Implements ISO 27701 control 6.7.1.6 to define and enforce pii retention periods. This privacy-specific control extends ISO 27001 requirements to address privacy information management.
...
Feature: Retention Period
  ...
  I want to implement retention period
  So that I can meet ISO 27701 6.7.1.6 requirements
