---
id: comp-iso27701-008-data-minimization
...
**Purpose**: Limit PII collection to what is necessary  
**ISO 27701 Control**: 6.7.2.1  
...
Implements ISO 27701 control 6.7.2.1 to limit pii collection to what is necessary. This privacy-specific control extends ISO 27001 requirements to address privacy information management.
...
Feature: Data Minimization
  ...
  I want to implement data minimization
  So that I can meet ISO 27701 6.7.2.1 requirements
