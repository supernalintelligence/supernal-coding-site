---
id: comp-iso27701-005-pii-in-records
...
**Purpose**: Manage PII within records management system  
**ISO 27701 Control**: 6.7.1.5  
...
Implements ISO 27701 control 6.7.1.5 to manage pii within records management system. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: PII in Records
  As a privacy officer
  I want to implement pii in records
  So that I can meet ISO 27701 6.7.1.5 requirements
