---
id: comp-iso27701-014-obligations-to-data-subjects-object
...
**Purpose**: Enable data subjects to object to processing  
**ISO 27701 Control**: 6.7.2.7  
...
Implements ISO 27701 control 6.7.2.7 to enable data subjects to object to processing. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Obligations to Data Subjects - Object
  As a privacy officer
  I want to implement obligations to data subjects - object
  So that I can meet ISO 27701 6.7.2.7 requirements
