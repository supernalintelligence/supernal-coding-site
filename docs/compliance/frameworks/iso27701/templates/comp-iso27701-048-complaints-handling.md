---
id: comp-iso27701-048-complaints-handling
...
**Purpose**: Establish process for privacy complaints  
**ISO 27701 Control**: 6.13.1  
...
Implements ISO 27701 control 6.13.1 to establish process for privacy complaints. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Complaints Handling
  As a privacy officer
  I want to implement complaints handling
  So that I can meet ISO 27701 6.13.1 requirements
