---
id: comp-iso27701-013-obligations-to-data-subjects-automated-decision-making
...
**Purpose**: Address automated decision-making concerns  
**ISO 27701 Control**: 6.7.2.6  
**Category**: privacy-controller  
**Priority**: high  
**Framework**: ISO 27701 (Privacy Extension)

## Description

Implements ISO 27701 control 6.7.2.6 to address automated decision-making concerns. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Obligations to Data Subjects - Automated Decision Making
  As a privacy officer
  I want to implement obligations to data subjects - automated decision making
  So that I can meet ISO 27701 6.7.2.6 requirements
