---
id: comp-iso27701-023-disclosure-to-third-parties
...
**Purpose**: Do not disclose PII without authorization  
**ISO 27701 Control**: 6.8.1.3  
...
Implements ISO 27701 control 6.8.1.3 to do not disclose pii without authorization. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Disclosure to Third Parties
  As a privacy officer
  I want to implement disclosure to third parties
  So that I can meet ISO 27701 6.8.1.3 requirements
