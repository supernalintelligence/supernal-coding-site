---
id: comp-iso27701-017-retention-period-for-logs
...
**Purpose**: Define retention for logs containing PII  
**ISO 27701 Control**: 6.7.3.2  
...
Implements ISO 27701 control 6.7.3.2 to define retention for logs containing pii. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Retention Period for Logs
  As a privacy officer
  I want to implement retention period for logs
  So that I can meet ISO 27701 6.7.3.2 requirements
