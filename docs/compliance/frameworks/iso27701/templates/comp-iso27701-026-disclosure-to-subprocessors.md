---
id: comp-iso27701-026-disclosure-to-subprocessors
...
**Purpose**: Manage subprocessor relationships properly  
**ISO 27701 Control**: 6.8.2.1  
...
Implements ISO 27701 control 6.8.2.1 to manage subprocessor relationships properly. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Disclosure to Subprocessors
  As a privacy officer
  I want to implement disclosure to subprocessors
  So that I can meet ISO 27701 6.8.2.1 requirements
