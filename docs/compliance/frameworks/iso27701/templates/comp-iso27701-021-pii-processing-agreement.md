---
id: comp-iso27701-021-pii-processing-agreement
...
**Purpose**: Establish PII processing agreements with customers  
**ISO 27701 Control**: 6.8.1.1  
...
Implements ISO 27701 control 6.8.1.1 to establish pii processing agreements with customers. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: PII Processing Agreement
  As a privacy officer
  I want to implement pii processing agreement
  So that I can meet ISO 27701 6.8.1.1 requirements
