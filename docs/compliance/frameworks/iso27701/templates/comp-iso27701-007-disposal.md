...
**Purpose**: Securely dispose of PII when no longer required  
**ISO 27701 Control**: 6.7.1.7  
...
Implements ISO 27701 control 6.7.1.7 to securely dispose of pii when no longer required. This privacy-specific control extends ISO 27001 requirements to address privacy information management.
...
Feature: Disposal
  ...
  So that I can meet ISO 27701 6.7.1.7 requirements
