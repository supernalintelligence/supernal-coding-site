---
id: comp-iso27701-049-supervisory-authority-cooperation
...
**Purpose**: Cooperate with supervisory authorities  
**ISO 27701 Control**: 6.13.2  
...
Implements ISO 27701 control 6.13.2 to cooperate with supervisory authorities. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Supervisory Authority Cooperation
  As a privacy officer
  I want to implement supervisory authority cooperation
  So that I can meet ISO 27701 6.13.2 requirements
