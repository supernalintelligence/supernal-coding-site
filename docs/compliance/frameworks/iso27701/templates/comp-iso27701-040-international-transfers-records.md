---
id: comp-iso27701-040-international-transfers-records
...
**Purpose**: Maintain records of international transfers  
**ISO 27701 Control**: 6.10.3  
...
Implements ISO 27701 control 6.10.3 to maintain records of international transfers. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: International Transfers - Records
  As a privacy officer
  I want to implement international transfers - records
  So that I can meet ISO 27701 6.10.3 requirements
