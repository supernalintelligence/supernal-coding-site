---
id: comp-iso27701-061-vendor-privacy-assessment
...
**Purpose**: Assess vendor privacy practices  
**ISO 27701 Control**: 6.18.1  
...
Implements ISO 27701 control 6.18.1 to assess vendor privacy practices. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Vendor Privacy Assessment
  As a privacy officer
  I want to implement vendor privacy assessment
  So that I can meet ISO 27701 6.18.1 requirements
