---
id: comp-iso27701-052-encryption-of-pii
...
**Purpose**: Encrypt PII in transit and at rest  
**ISO 27701 Control**: 6.15.1  
...
Implements ISO 27701 control 6.15.1 to encrypt pii in transit and at rest. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Encryption of PII
  As a privacy officer
  I want to implement encryption of pii
  So that I can meet ISO 27701 6.15.1 requirements
