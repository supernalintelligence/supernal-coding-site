---
id: comp-iso27701-011-obligations-to-data-subjects-rectification
...
**Purpose**: Enable data subjects to rectify their PII  
**ISO 27701 Control**: 6.7.2.4  
...
Implements ISO 27701 control 6.7.2.4 to enable data subjects to rectify their pii. This privacy-specific control extends ISO 27001 requirements to address privacy information management.

## Acceptance Criteria

```gherkin
Feature: Obligations to Data Subjects - Rectification
  As a privacy officer
  I want to implement obligations to data subjects - rectification
  So that I can meet ISO 27701 6.7.2.4 requirements
