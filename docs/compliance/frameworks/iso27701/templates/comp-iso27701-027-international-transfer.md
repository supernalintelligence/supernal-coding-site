---
id: comp-iso27701-027-international-transfer
...
**Purpose**: Ensure proper controls for international PII transfers  
**ISO 27701 Control**: 6.8.2.2  
...
Implements ISO 27701 control 6.8.2.2 to ensure proper controls for international pii transfers. This privacy-specific control extends ISO 27001 requirements to address privacy information management.
...
Feature: International Transfer
  ...
  I want to implement international transfer
  So that I can meet ISO 27701 6.8.2.2 requirements
