...
Implements HIPAA Security Rule requirement §164.312(e)(2)(ii) to implement mechanism to encrypt ephi during transmission. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Encryption
  ...
  So that I can meet HIPAA Security Rule §164.312(e)(2)(ii) requirements
