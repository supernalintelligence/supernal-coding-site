---
id: comp-hipaa-018-log-in-monitoring
...
Implements HIPAA Security Rule requirement §164.308(a)(5)(ii)(C) to implement procedures for monitoring log-in attempts. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).

## Acceptance Criteria

```gherkin
Feature: Log-in Monitoring
  As a HIPAA compliance officer
  I want to implement log-in monitoring
  So that I can meet HIPAA Security Rule §164.308(a)(5)(ii)(C) requirements
