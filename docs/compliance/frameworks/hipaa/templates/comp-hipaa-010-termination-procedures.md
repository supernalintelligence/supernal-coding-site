---
id: comp-hipaa-010-termination-procedures
...
**Purpose**: Implement procedures for terminating workforce member access  
...
Implements HIPAA Security Rule requirement §164.308(a)(3)(ii)(C) to implement procedures for terminating workforce member access. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Termination Procedures
  ...
  I want to implement termination procedures
  So that I can meet HIPAA Security Rule §164.308(a)(3)(ii)(C) requirements
