---
id: comp-hipaa-035-maintenance-records
...
**Purpose**: Implement policies to document facility maintenance  
**HIPAA Reference**: §164.310(a)(2)(iv)  
**Category**: physical  
**Priority**: medium  
...
Implements HIPAA Security Rule requirement §164.310(a)(2)(iv) to implement policies to document facility maintenance. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Maintenance Records
  ...
  I want to implement maintenance records
  So that I can meet HIPAA Security Rule §164.310(a)(2)(iv) requirements
