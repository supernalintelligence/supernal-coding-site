---
id: comp-hipaa-027-applications-and-data-criticality-analysis
...
**Purpose**: Assess relative criticality of applications and data  
**HIPAA Reference**: §164.308(a)(7)(ii)(E)  
...
Implements HIPAA Security Rule requirement §164.308(a)(7)(ii)(E) to assess relative criticality of applications and data. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).

## Acceptance Criteria

```gherkin
Feature: Applications and Data Criticality Analysis
  As a HIPAA compliance officer
  I want to implement applications and data criticality analysis
  So that I can meet HIPAA Security Rule §164.308(a)(7)(ii)(E) requirements
