---
id: comp-hipaa-040-media-re-use
...
**Purpose**: Implement procedures to remove ePHI before media re-use  
...
Implements HIPAA Security Rule requirement §164.310(d)(2)(ii) to implement procedures to remove ephi before media re-use. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).

## Acceptance Criteria

```gherkin
Feature: Media Re-use
  As a HIPAA compliance officer
  I want to implement media re-use
  So that I can meet HIPAA Security Rule §164.310(d)(2)(ii) requirements
