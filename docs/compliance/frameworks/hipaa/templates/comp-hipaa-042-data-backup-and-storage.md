---
id: comp-hipaa-042-data-backup-and-storage
...
**Purpose**: Create retrievable exact copy of ePHI before equipment movement  
**HIPAA Reference**: §164.310(d)(2)(iv)  
**Category**: physical  
**Priority**: high  
...
Implements HIPAA Security Rule requirement §164.310(d)(2)(iv) to create retrievable exact copy of ephi before equipment movement. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).

## Acceptance Criteria

```gherkin
Feature: Data Backup and Storage
  As a HIPAA compliance officer
  I want to implement data backup and storage
  So that I can meet HIPAA Security Rule §164.310(d)(2)(iv) requirements
