---
id: comp-hipaa-059-documentation-time-limit
...
**Purpose**: Retain documentation for 6 years from creation or last effective date  
**HIPAA Reference**: §164.316(b)(1)(i)  
...
Implements HIPAA Security Rule requirement §164.316(b)(1)(i) to retain documentation for 6 years from creation or last effective date. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).

## Acceptance Criteria

```gherkin
Feature: Documentation - Time Limit
  As a HIPAA compliance officer
  I want to implement documentation - time limit
  So that I can meet HIPAA Security Rule §164.316(b)(1)(i) requirements
