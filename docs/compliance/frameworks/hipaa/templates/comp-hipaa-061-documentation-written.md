---
id: comp-hipaa-061-documentation-written
...
**Purpose**: Maintain policies and procedures in written form  
**HIPAA Reference**: §164.316(b)(2)(i)  
...
Implements HIPAA Security Rule requirement §164.316(b)(2)(i) to maintain policies and procedures in written form. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Documentation - Written
  ...
  I want to implement documentation - written
  So that I can meet HIPAA Security Rule §164.316(b)(2)(i) requirements
