---
id: comp-hipaa-013-access-authorization
...
Implements HIPAA Security Rule requirement §164.308(a)(4)(ii)(B) to implement policies for granting access to ephi. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Access Authorization
  ...
  I want to implement access authorization
  So that I can meet HIPAA Security Rule §164.308(a)(4)(ii)(B) requirements
