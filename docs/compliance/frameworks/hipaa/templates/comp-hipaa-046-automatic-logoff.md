---
id: comp-hipaa-046-automatic-logoff
...
**Purpose**: Implement electronic procedure to terminate session after inactivity  
...
Implements HIPAA Security Rule requirement §164.312(a)(2)(iii) to implement electronic procedure to terminate session after inactivity. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).

## Acceptance Criteria

```gherkin
Feature: Automatic Logoff
  As a HIPAA compliance officer
  I want to implement automatic logoff
  So that I can meet HIPAA Security Rule §164.312(a)(2)(iii) requirements
