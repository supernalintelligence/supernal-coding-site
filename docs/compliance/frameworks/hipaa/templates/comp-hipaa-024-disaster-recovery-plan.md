---
id: comp-hipaa-024-disaster-recovery-plan
...
**Purpose**: Establish procedures to restore lost data  
...
Implements HIPAA Security Rule requirement §164.308(a)(7)(ii)(B) to establish procedures to restore lost data. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Disaster Recovery Plan
  ...
  I want to implement disaster recovery plan
  So that I can meet HIPAA Security Rule §164.308(a)(7)(ii)(B) requirements
