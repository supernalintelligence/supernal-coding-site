---
id: comp-hipaa-006-assigned-security-responsibility
...
**Purpose**: Identify security official responsible for security policies  
...
Implements HIPAA Security Rule requirement §164.308(a)(2) to identify security official responsible for security policies. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).

## Acceptance Criteria

```gherkin
Feature: Assigned Security Responsibility
  As a HIPAA compliance officer
  I want to implement assigned security responsibility
  So that I can meet HIPAA Security Rule §164.308(a)(2) requirements
