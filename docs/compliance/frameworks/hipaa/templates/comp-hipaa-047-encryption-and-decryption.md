---
id: comp-hipaa-047-encryption-and-decryption
...
Implements HIPAA Security Rule requirement §164.312(a)(2)(iv) to implement mechanism to encrypt and decrypt ephi. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Encryption and Decryption
  ...
  I want to implement encryption and decryption
  So that I can meet HIPAA Security Rule §164.312(a)(2)(iv) requirements
