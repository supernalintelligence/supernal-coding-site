---
id: comp-hipaa-043-access-control
...
**Purpose**: Implement technical policies to allow only authorized access to ePHI  
...
Implements HIPAA Security Rule requirement §164.312(a)(1) to implement technical policies to allow only authorized access to ephi. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Access Control
  ...
  I want to implement access control
  So that I can meet HIPAA Security Rule §164.312(a)(1) requirements
