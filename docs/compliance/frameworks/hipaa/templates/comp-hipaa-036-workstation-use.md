---
id: comp-hipaa-036-workstation-use
...
**Purpose**: Implement policies for proper workstation functions and security  
...
Implements HIPAA Security Rule requirement §164.310(b) to implement policies for proper workstation functions and security. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).

## Acceptance Criteria

```gherkin
Feature: Workstation Use
  As a HIPAA compliance officer
  I want to implement workstation use
  So that I can meet HIPAA Security Rule §164.310(b) requirements
