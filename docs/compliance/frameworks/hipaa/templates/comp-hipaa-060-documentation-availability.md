---
id: comp-hipaa-060-documentation-availability
...
**Purpose**: Make documentation available to those responsible for implementation  
**HIPAA Reference**: §164.316(b)(1)(ii)  
...
Implements HIPAA Security Rule requirement §164.316(b)(1)(ii) to make documentation available to those responsible for implementation. This control ensures compliance with federal healthcare information security regulations for protecting electronic Protected Health Information (ePHI).
...
Feature: Documentation - Availability
  ...
  I want to implement documentation - availability
  So that I can meet HIPAA Security Rule §164.316(b)(1)(ii) requirements
