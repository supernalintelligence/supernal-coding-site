---
id: comp-en18031-023-model-drift-detection
title: COMP-EN18031-023 - Model Drift Detection
sidebar_label: COMP-EN18031-023
sidebar_position: 23
---
...
**Purpose**: Monitor and detect model drift  
**EN 18031 Control**: 5.3.8  
**Category**: ai-model  
**Priority**: high  
**Framework**: EN 18031
...
Implements EN 18031 control 5.3.8 to monitor and detect model drift. This control ensures AI system trustworthiness, security, and compliance with emerging AI regulations.
...
Feature: Model Drift Detection
  ...
  I want to implement model drift detection
  So that I can meet EN 18031 5.3.8 requirements
