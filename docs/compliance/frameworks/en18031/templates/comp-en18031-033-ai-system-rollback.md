...
**Purpose**: Implement AI system rollback procedures  
...
Implements EN 18031 control 5.4.8 to implement ai system rollback procedures. This control ensures AI system trustworthiness, security, and compliance with emerging AI regulations.
...
Feature: AI System Rollback
  ...
  I want to implement ai system rollback
  So that I can meet EN 18031 5.4.8 requirements
