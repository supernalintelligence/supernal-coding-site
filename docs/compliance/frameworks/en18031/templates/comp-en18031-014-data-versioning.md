...
Implements EN 18031 control 5.2.6 to version control for datasets. This control ensures AI system trustworthiness, security, and compliance with emerging AI regulations.
...
Feature: Data Versioning
  ...
  I want to implement data versioning
  So that I can meet EN 18031 5.2.6 requirements
