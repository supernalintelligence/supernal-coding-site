...
sidebar_label: COMP-EN18031-020
sidebar_position: 20
---
...
**Purpose**: Implement explainable AI techniques  
**EN 18031 Control**: 5.3.5  
**Category**: ai-model  
**Priority**: high  
**Framework**: EN 18031
...
Implements EN 18031 control 5.3.5 to implement explainable ai techniques. This control ensures AI system trustworthiness, security, and compliance with emerging AI regulations.
...
Feature: Model Explainability
  ...
  I want to implement model explainability
  So that I can meet EN 18031 5.3.5 requirements
