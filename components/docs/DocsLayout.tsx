...
export default function DocsLayout({
  ...
  return (
    <div className="flex-1">
      ...
      <div className={shouldShowTOC ? 'lg:mr-72' : ''}>
      ...
      {shouldShowTOC && (
        <aside className="hidden lg:block fixed right-0 top-16 bottom-0 w-72 border-l border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-y-auto">
          <div className="p-5">
